...
router
  ...
  .get(async (req, res) => {
    ...
    try {
      req.params.profileId = validation.checkId(
    ...
    try {
      const profile = await profileData.getProfile(profileId)
  ...
  .patch(async (req, res) => {
    ...
    try {
      const updatedProfile = await profileData.updateProfile(
        req.params.profileId,
        requestBody
      )
  ...
  .delete(async (req, res) => {
    ...
    try {
      const deletedProfile = await profileData.removeProfile(
        req.params.profileId
      )
